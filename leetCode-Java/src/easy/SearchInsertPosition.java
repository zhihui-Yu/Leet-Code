...
public class SearchInsertPosition {
    ...
    public static void main(String[] args) {
        System.out.println(new SearchInsertPosition().searchInsert(new int[]{1, 3, 5}, 6)); // 3
        System.out.println(new SearchInsertPosition().searchInsert(new int[]{1, 3, 5}, 4)); // 2
        System.out.println(new SearchInsertPosition().searchInsert(new int[]{1}, 1)); // 0
