...
public class ArithmeticSubarrays {
    ...
    private Boolean check(int[] nums, int begin, int end) {
        var arr = Arrays.copyOfRange(nums, begin, end + 1);
        Arrays.sort(arr);
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new ArithmeticSubarrays().checkArithmeticSubarrays(new int[]{4, 6, 5, 9, 3, 7}, new int[]{0, 0, 2}, new int[]{2, 3, 5}).toArray()));
    }
}
