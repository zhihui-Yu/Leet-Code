...
public class DesignSpreadsheet {
    ...
    static class Spreadsheet {
        ...
        public int getValue(String formula) {
            ...
            String x = formula.substring(1, index);
            String y = formula.substring(index + 1);

            int cell1 = Character.isLetter(x.charAt(0)) ? sheet.getOrDefault(x, 0) : Integer.parseInt(x);
            int cell2 = Character.isLetter(y.charAt(0)) ? sheet.getOrDefault(y, 0) : Integer.parseInt(y);
            return cell1 + cell2;
        }
    }
}
