...
public class LexicographicallySmallestStringAfterSubstringOperation {
    ...
    // 找到第一个非'a'的字符，开始遍历，到结尾或者与到'a'结束。
    // 如果全是'a' 则最后一个字符改为'z' => 必须执行一次
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new LexicographicallySmallestStringAfterSubstringOperation().smallestString("aaa"));
    }
}
